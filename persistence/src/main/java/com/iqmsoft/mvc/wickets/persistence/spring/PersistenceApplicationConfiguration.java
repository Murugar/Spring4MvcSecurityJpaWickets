...
@Configuration
@Lazy
@EnableJpaRepositories(basePackageClasses = {DummyRepository.class, CategoryDummyRepository.class})
...
public class PersistenceApplicationConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		bean.setPackagesToScan(new String[] { "com.iqmsoft.mvc.wickets.persistence.dao" });
